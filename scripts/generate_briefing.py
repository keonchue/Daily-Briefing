...
{{"summary":"2문장 요약","cards":[{{"tag":"카테고리","headline":"제목","body":"2-3문장. 구체적 수치 포함.","insight":"소비자학 관점 시사점 1-2문장","sources":[{{"title":"출처명","url":"https://..."}}]}}]}}
cards 3-4개. 한국은행 기준금리 / USD/KRW 환율 / KOSPI / 거시경제 흐름 각각 다루기. 각 카드마다 실제 참고한 웹페이지 출처를 1-2개 포함하세요.""",
    "politics": f"""{today} 기준 주요 정치·사회 이슈를 웹 검색으로 조사하고 아래 JSON만 반환하세요:
{{"summary":"2문장 요약","cards":[{{"tag":"카테고리","headline":"제목","body":"2-3문장 설명.","insight":"소비자·시장 영향 1-2문장","sources":[{{"title":"출처명","url":"https://..."}}]}}]}}
cards 3-4개. 국내외 주요 이슈 포함. 각 카드마다 실제 참고한 웹페이지 출처를 1-2개 포함하세요.""",
    "consumer": f"""{today} 기준 소비자 트렌드·마케팅 이슈를 웹 검색으로 조사하고 아래 JSON만 반환하세요:
{{"summary":"2문장 요약","cards":[{{"tag":"카테고리","headline":"제목","body":"2-3문장. 소비자학 맥락 포함.","insight":"소비자학 이론 연결 1-2문장","sources":[{{"title":"출처명","url":"https://..."}}]}}]}}
cards 3-4개. 마케팅 전략 / MZ소비 / ESG / 유통 트렌드 포함. 각 카드마다 실제 참고한 웹페이지 출처를 1-2개 포함하세요."""
}
